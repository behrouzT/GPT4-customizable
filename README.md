# Mr. GPT4 : Your personalized AI Tutor!

Unlock the potential of GPT-4 with Mr. GPT4 AI Tutor, a customizable prompt that delivers personalized learning experiences for users with diverse needs and interests.

## Table of Contents
- [Mr. GPT4: Your personalized AI Tutor!](#mr-ranedeer-your-personalized-ai-tutor)
  - [Table of Contents](#table-of-contents)
  - [Why Mr. GPT4 AI Tutor?](#why-mr-ranedeer-ai-tutor)
...
## Why Mr. GPT4 AI Tutor?

Mr. GPT4 AI Tutor allows you to:
...
3. Copy and paste the contents of [Mr_GPT4.json](https://raw.githubusercontent.com/behrouzT/GPT4-customizable/main/Mr_GPT4.json) into the prompt
4. Let Mr. GPT4 guide you through the configuration process
5. Start learning!
